...
const require$$0$1 = require('readline');
...
const cwd = process.cwd();
const copy = (src, dest) => {
  const state = require$$0$2.statSync(src);
  require$$0$2.cpSync(src, dest, { recursive: state.isDirectory() });
};
const createProject = async () => {
  try {
    ...
    const templateDir = require$$0$3.resolve(__dirname, `../src/templates/${result.template}`);
    const commonDir = require$$0$3.resolve(__dirname, "../src/common");
